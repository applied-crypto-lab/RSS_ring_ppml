...
void maximum(Lint **res, Lint **a, uint ring_size, uint size, uint batch_size, NodeNetwork *nodeNet) {
    ...
    if (size > 1) {
        ...
        Rss_LT(ap, a0, a1, new_size_ceil * batch_size, ring_size, nodeNet);
        ...
        maximum(res, ap, ring_size, new_size, batch_size, nodeNet);
...
void eda_maximum(Lint **res, Lint **a, uint ring_size, uint size, uint batch_size, NodeNetwork *nodeNet) {
    ...
    if (size > 1) {
        ...
        new_Rss_LT(ap, a0, a1, new_size_ceil * batch_size, ring_size, nodeNet);
        ...
        eda_maximum(res, ap, ring_size, new_size, batch_size, nodeNet);
...
void arg_max(Lint **res, Lint **res_index, Lint **a, uint ring_size, uint size, uint batch_size, NodeNetwork *nodeNet) {
    ...
    if (size > 1) {
        ...
        Rss_MSB(c, diff, total_new_ceil, ring_size, nodeNet);
        ...
        Rss_Mult(d0, c, diff, total_new_ceil, ring_size, nodeNet);
        ...
        arg_max_helper(res, res_index, ap, index, ring_size, new_size, batch_size, nodeNet);
...
void arg_max_helper(Lint **res, Lint **res_index, Lint **a, Lint **a_index, uint ring_size, uint size, uint batch_size, NodeNetwork *nodeNet) {
    ...
    if (size > 1) {
        ...
        // uint total_new = new_size * batch_size;
        uint total_new_ceil = new_size_ceil * batch_size;
        // std::cout << "total_new = " <<total_new<< std::endl;
        // std::cout << "total_new_ceil = " <<total_new_ceil<< std::endl;
...
void eda_arg_max(Lint **res, Lint **res_index, Lint **a, uint ring_size, uint size, uint batch_size, NodeNetwork *nodeNet) {
    ...
    if (size > 1) {
        ...
        new_Rss_MSB(c, diff, total_new_ceil, ring_size, nodeNet);
        ...
        eda_arg_max_helper(res, res_index, ap, index, ring_size, new_size, batch_size, nodeNet);
...
void eda_arg_max_time(Lint **res, Lint **res_index, Lint **a, uint ring_size, uint size, uint batch_size, NodeNetwork *nodeNet, unsigned long &timer) {
    ...
    if (size > 1) {
        ...
        new_Rss_MSB_time(c, diff, total_new_ceil, ring_size, nodeNet, timer);
        ...
        eda_arg_max_helper_time(res, res_index, ap, index, ring_size, new_size, batch_size, nodeNet, timer);
